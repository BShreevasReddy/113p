...
# Upload the data if you are using google collab
...
# Step1: Remove the first element from the list
savings_data.pop(0)
# savings_data.pop(1)
# savings_data.pop(2)
# savings_data.pop(3)
...
age = []
# Step 2: Create empty list named savings
savings = []
# savings = ()
# savings = {}
# savings = <>
...
# Step 3: to create Distribution plot choose from the options below 

fig = ff.create_distplot([new_df["quant_saved"].tolist()], ["Savings"], show_hist=False)
# fig = ff.create_distplot([new_df["quant_saved"].tolist()], ["Savings"], show_hist=True)
# fig = ff.create_distplot([new_df["quant_saved"].tolist], ["Savings"], show_hist=False)
# fig = ff.createdistplot([new_df["quant_saved"].tolist()], ["Savings"], show_hist=False)
fig.show()
